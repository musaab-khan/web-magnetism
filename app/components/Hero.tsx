...
const Hero = () => {
  return (
    <div className='overflow-hidden p-4 md:p-0 flex justify-center items-center h-[100vh] flex-col text-white relative overflow-x-hidden gap-11' style={{background: 'linear-gradient(102.26deg, #5B53F9 -13.11%, #AC71D6 36.24%, #FF8E57 110.26%)'}}>
      <h1 className='z-3 text-white font-bold text-3xl md:text-7xl 2xl:text-[10rem] text-center'>WEB MAGNETISM</h1>
      <p className='z-3 text-xl text-white w-full md:w-[50%] text-center 2xl:text-4xl'>Transforming Businesses with unique Web design and strategic digital marketing for impactful online visibility.</p>
